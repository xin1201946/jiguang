...
import {
  deviceProjectQuery,
  deviceProjectTableColumns
} from '@views/control/deviceProjiect/deviceProject.config'
...
export default {
  ...
  data() {
    return {
      data: [],
      columns: deviceProjectTableColumns,
      query: {
  ...
  mounted() {
    this.$refs.query.init(deviceProjectQuery)
  },
  methods: {
    getList() {
      const data = {
